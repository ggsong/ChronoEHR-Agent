#!/usr/bin/env python3
"""Run feature-time audit for the CKD demo config."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=PROJECT / "configs" / "ckd_mimic_readmission.yaml")
    parser.add_argument("--feature-map", type=Path, default=PROJECT / "docs" / "mimic_ckd_feature_time_map.csv")
...
def main() -> None:
    ...
    table_path = args.project_root / "outputs" / "tables" / "mimic_ckd_feature_time_audit.csv"
    report_path = args.project_root / "outputs" / "reports" / "mimic_ckd_feature_time_audit_report.md"
    ...
    print(f"CKD feature time audit checked {summary['variables_checked']} variables")
