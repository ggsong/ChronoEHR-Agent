#!/usr/bin/env python3
"""Run hypertension prediction-time logistic baselines."""
...
def main() -> None:
    args = parse_args()
    config = load_prediction_time_config("hypertension")
    ...
    print("MIMIC hypertension prediction-time models complete")
